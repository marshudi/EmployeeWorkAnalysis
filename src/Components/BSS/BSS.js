...
const BSS = () => {
  ...
  useEffect(() => {
    ...
    const onsiteCheckbox = onsiteCheckboxRef.current;
    const offsiteCheckbox = offsiteCheckboxRef.current;
    ...
    // Checkbox event listeners for chart update
    const handleCheckboxChange = () => {
      updateChart();
    };
    onsiteCheckbox.addEventListener("change", handleCheckboxChange);
    offsiteCheckbox.addEventListener("change", handleCheckboxChange);
    ...
    return () => {
      ...
      onsiteCheckbox.removeEventListener("change", handleCheckboxChange);
      offsiteCheckbox.removeEventListener("change", handleCheckboxChange);
  ...
  return (
    <div className="bg-gray-100">
      <div className="container mx-auto px-4 lg:px-10 py-6 bg-white shadow-lg rounded-lg mt-10">
          ...
          <div className="mb-4">
            <div className="flex" id="location-toggle">
              <div className="flex items-center me-4">
                <input id="onsite" ref={onsiteCheckboxRef} type="checkbox" name="location" value="onsite" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500" />
                <label htmlFor="onsite" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">On‑Site</label>
              </div>
              <div className="flex items-center me-4">
                <input id="offsite" ref={offsiteCheckboxRef} type="checkbox" name="location" value="offsite" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500" />
                <label htmlFor="offsite" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Off‑Site</label>
              </div>
            </div>
          </div>
        ...
        {/* Expense Report Table (Ranking by Role) */}
